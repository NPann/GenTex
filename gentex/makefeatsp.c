...
/* Generate a feature space given an image,mask and template


/* this will be hard - don't know the dimension of the feature */
/* space array on the way in... */

/* ... the rest of this is still just comat.c*/


void
makefeatsp1D(int* input,
	     int* mask, 
	     int xi,
	     int* coords,
	     int levels, 
